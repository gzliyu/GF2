...
# User Options
#-----------------------------------------------------------------------------
set (${HDF4_PACKAGE_NAME}_BUILD_FORTRAN   ON)
set (${HDF4_PACKAGE_NAME}_BUILD_JAVA      ON)
...
set (${HDF4_PACKAGE_NAME}_BUILD_SHARED_LIBS    ON)
set (${HDF4_PACKAGE_NAME}_PACKAGE_EXTLIBS      ON)
set (${HDF4_PACKAGE_NAME}_EXPORT_LIBRARIES xdr-static;xdr-shared;hdf-static;hdf-shared;mfhdf-static;mfhdf-shared;mfhdf_fcstub-static;mfhdf_fcstub-shared;mfhdf_fortran-static;mfhdf_fortran-shared;hdf_fcstub-static;hdf_fcstub-shared;hdf_fortran-static;hdf_fortran-shared)
...
if (${HDF4_PACKAGE_NAME}_BUILD_JAVA)
  set (${HDF4_PACKAGE_NAME}_JAVA_INCLUDE_DIRS
      ${PACKAGE_PREFIX_DIR}/lib/jarhdf-4.2.14.jar
...
# Version Strings
#-----------------------------------------------------------------------------
set (${HDF4_PACKAGE_NAME}_VERSION_STRING 4.2.14)
set (${HDF4_PACKAGE_NAME}_VERSION_MAJOR  4.2)
set (${HDF4_PACKAGE_NAME}_VERSION_MINOR  14)
...
if (NOT TARGET "hdf4")
  if (${HDF4_PACKAGE_NAME}_ENABLE_JPEG_LIB_SUPPORT AND ${HDF4_PACKAGE_NAME}_PACKAGE_EXTLIBS AND NOT TARGET "jpeg")
    include (${PACKAGE_PREFIX_DIR}/cmake/jpeg/jpeg-targets.cmake)
  endif ()
